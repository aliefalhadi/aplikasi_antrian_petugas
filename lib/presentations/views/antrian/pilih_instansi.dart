...
class PilihInstansi extends StatelessWidget {
  const PilihInstansi({Key key}) : super(key: key);
        ...
        return Scaffold(
          ...
          Container(
            ...
            child: ListView.builder(
              itemCount: provider.daftarInstansiModel.data.length,
                ...
                return  InkWell(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(provider.daftarInstansiModel.data[index].instansiNama),

...
//
//     final detailHistoriAntrianModel = detailHistoriAntrianModelFromJson(jsonString);

import 'dart:convert';

DetailHistoriAntrianModel detailHistoriAntrianModelFromJson(String str) => DetailHistoriAntrianModel.fromJson(json.decode(str));

String detailHistoriAntrianModelToJson(DetailHistoriAntrianModel data) => json.encode(data.toJson());

class DetailHistoriAntrianModel {
  DetailHistoriAntrianModel({
    this.status,
    this.data,
  });
  ...
  factory DetailHistoriAntrianModel.fromJson(Map<String, dynamic> json) => DetailHistoriAntrianModel(
